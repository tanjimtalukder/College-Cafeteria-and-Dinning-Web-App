...
public class ControllerServlet extends HttpServlet {
        ...
        // if purchase action is called
            ...
            if (cart != null) {
                ...
                if (validationErrorFlag == true) {
                    ...
                    int orderId = placeOrder(name, email, phone, address, ccNumber, cart);
                    ...
                    if (orderId != 0) {
                        ...
                        // get order details
                        Map orderMap = getOrderDetails(orderId);
    ...
    //added helper method 
    private int placeOrder(String name, String email, String phone, String address, String ccNumber, ShoppingCart cart) { 
        try { 
            Customer customer = customerFacade.addCustomer(name, email, phone, address, ccNumber); 
            CustomerOrder order = customerOrderFacade.addOrder(customer, cart); 
            orderedProductFacade.addOrderedItems(order, cart); 
            return order.getId(); 
        } catch (Exception e) { 
